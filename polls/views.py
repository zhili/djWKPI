...
def handle_uploaded_file(f):
    try:
        ...
        fields = reader.next()
        cellsSet = {}
        sum_keys = ['K02', 'K01', 'K03', 'K04', 'K05', 'K08_a', 'K08_b', 'K09_a', 'K09_b', 'K10_a', 'K10_b', 'K11_a', 'K11_b', 'K12_a', 'K12_b', 'K13_1a', 'K13_1b', 'K13_2a', 'K13_2b', 'K14_1a', 'K14_1b', 'K16_a', 'K16_b', 'K19_a', 'K19_b', 'K20_a', 'K20_b', 'K21_a', 'K21_b', 'K24', 'K25_a', 'K25_b', 'K26_a', 'K26_b', 'K27', 'K29', 'K30_a', 'K30_b', 'K31_a', 'K31_b', 'K33_ucell', 'K22_ucell', 'K34_ucell', 'K15', 'K06', 'K28', 'K07', 'K23', 'K17_a', 'K17_b', 'K18_a', 'K18_b', 'K32_a', 'K32_b']
        ...
        for row in reader:
            ...
            for (name, value) in items:
                ...
                item[name] = v
            if item:
                if cellsSet.has_key(item['UCell Name']):
                    new_dict = cellsSet[item['UCell Name']]
                    for k in sum_keys:
                        new_dict[k] += item[k]
                    cellsSet[item['UCell Name']] = new_dict
                else:
                    cellsSet[item['UCell Name']] = item         
        for cell in cellsSet.keys():
            hdict = cellsSet[cell]
            if Cell.objects.filter(cell_name=cell).exists():
                ucell = Cell.objects.get(cell_name=cell)
            else:
                ucell = Cell.objects.create(rnc_id=hdict['RNC Id'],cell_name=cell)
            item_date = datetime.strptime(hdict['Date'], '%m/%d/%Y %I:%M:%S %p') + timedelta(hours=int(hdict['Hour']), minutes=0)
